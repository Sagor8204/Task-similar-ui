...
export default function Header() {
  return (
    <div className="flex items-center justify-between py-2 max-w-[1400px] mx-auto">
      <h1 className="text-[40px] font-semibold">Banking</h1>
      <div className="flex items-center gap-5">
        <div className="flex items-center gap-2 border border-gray-300 shadow-sm w-52 px-2 py-2 rounded-md font-semibold text-sm">
